  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed z-40 bottom-20 end-4 lg:bottom-6 lg:end-6 h-14 w-14 rounded-full shadow-lg flex items-center justify-center text-white transition-transform hover:scale-105 active:scale-95 ${
          isActive ? 'bg-violet-600' : 'bg-honey-500'
        } ${open ? 'hidden' : ''}`}
      >
